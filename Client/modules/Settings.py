...
class Settings:
    ...
    BUTTON_FILE_SHARING = f"background-image: url({Path(__file__).parent.parent / 'images' / 'icons' / 'cil-folder-open.png'});" if PLATFORM == "linux" else f"background-image: url({Path(__file__).parent.parent / 'images' / 'icons' / 'cil-folder-open.png'});".replace('\\', '/')
    BUTTON_ACCOUNT_SETTINGS = f"background-image: url({Path(__file__).parent.parent / 'images' / 'icons' / 'icon_settings.png'});" if PLATFORM == "linux" else f"background-image: url({Path(__file__).parent.parent / 'images' / 'icons' / 'icon_settings.png'});".replace('\\', '/')